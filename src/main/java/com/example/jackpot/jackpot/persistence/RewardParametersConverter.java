...
@Converter
public class RewardParametersConverter
    ...
    public String convertToDatabaseColumn(Map<String, BigDecimal> parameters) {
        try {
            ...
            throw new IllegalArgumentException("Could not serialize reward parameters", exception);
        }
    }
    ...
    public Map<String, BigDecimal> convertToEntityAttribute(String value) {
        try {
            ...
            throw new IllegalArgumentException(
                    "Could not deserialize reward parameters", exception);
        }
    }
}
